const Socials = ({ style }) => {
  ...
  return (
    <div id="socials" className={style}>

      <a href="mailto:customercare@ilovepizza.ie" rel="noopener noreferrer" target="_blank">
      ...
      <a href="https://www.facebook.com/IndependentPizzaCo/" rel="noopener noreferrer" target="_blank">
        <svg viewBox="0 0 24 24">
      ...
      <a href="https://www.instagram.com/independentpizzaco" rel="noopener noreferrer" target="_blank">
        <svg viewBox="0 0 24 24">
